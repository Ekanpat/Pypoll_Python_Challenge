...
counties = []
county_votes = {}
#num_county_Jefferson = 0
#num_county_Denver = 0
#num_county_Arapahoe = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        # f"\nCounty Results\n"
        # f"-------------------------\n"
        # #print(f"counties: {total_county_votes:,}\n")
        # f"-------------------------\n")
...
# 6f: Write a decision statement to determine the winning county and get its vote count.
    ...
    # print(winning_county_count)
    # print(winning_county_name)
            
            # winning_county_count = 0

# 7: Print the county with the largest turnout to the terminal.
    winning_county_name_summary = (
        f"-------------------------\n"
        f"Largest County Turnout: {winning_county_name}\n"
        #f"winning county name: {county}\n"
        f"-------------------------\n")
    print(winning_county_name_summary, end=" ")
